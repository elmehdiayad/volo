  ...
  const getColumns = (): GridColDef<bookcarsTypes.Booking>[] => {
    ...
    if (!hideCarColumn) {
      _columns.unshift({
        ...
        valueGetter: (value: bookcarsTypes.Car) => value.fullModelName || value.carModel,
      })
    }
                ...
                <div key={booking._id} className="booking-details">
                  ...
                  <div className="booking-detail" style={{ height: bookingDetailHeight }}>
                    ...
                    <div className="booking-detail-value">
                      <Link href={`car/${(booking.car as bookcarsTypes.Car)._id}`}>{(booking.car as bookcarsTypes.Car).fullModelName}</Link>
                    </div>
                  </div>
                  <div className="booking-detail" style={{ height: bookingDetailHeight }}>
